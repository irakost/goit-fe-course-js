...
return this._size;
  ...
  calculatePrice() {
      ...
      price = price + this._toppings.reduce(function(total, current){
          total = total + Hamburger.TOPPINGS[current].price;
          return total;
      },0);
      price = price + Hamburger.STUFFINGS[this._stuffing].price;
      return price;
  }
  ...
  calculateCalories() {
    let calories = 0;
    calories = calories + Hamburger.SIZES[this._size].calories;
    calories = calories + this._toppings.reduce(function (total, current) {
        total = total + Hamburger.TOPPINGS[current].calories;
        return total;
    }, 0);
    calories = calories + Hamburger.STUFFINGS[this._stuffing].calories;
    return calories;
}
}
